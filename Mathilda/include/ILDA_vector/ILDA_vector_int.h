...
static const ILDA_vector2i ILDA_vector2i_one = {.x = 1, .y = 1};
...
static const ILDA_vector3i ILDA_vector3i_one = {.x = 1, .y = 1, .z = 1};
...
static const ILDA_vector4i ILDA_vector4i_one = {.x = 1, .y = 1, .z = 1, .w = 1};
