...
static const ILDA_vector2f ILDA_vector2f_one = {.x = 1, .y = 1};
...
static const ILDA_vector3f ILDA_vector3f_one = {.x = 1, .y = 1, .z = 1};
...
static const ILDA_vector4f ILDA_vector4f_one = {.x = 1, .y = 1, .z = 1, .w = 1};
